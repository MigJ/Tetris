...
** Last update Sun Mar 19 16:05:01 2017 detroy_j
*/
...
int	detect_full_line(WINDOW *ground, int col, int);
...
void            window(t_options *opts, char **piece,
		       t_window win, t_game game);
